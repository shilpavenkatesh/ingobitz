...
var deprecationMessage = function deprecationMessage(optionsMap, prefix) {
...
var checkDeprecatedThemeOptions = function checkDeprecatedThemeOptions(options) {
  if (Object.keys(deprecatedThemeOptions).find(function (key) {
    return !!options[key];
  })) {
...
var checkDeprecatedLayoutOptions = function checkDeprecatedLayoutOptions(options) {
  if (Object.keys(deprecatedLayoutOptions).find(function (key) {
...
function _default(_ref2) {
  ...
  var api = {
    ...
    setOptions: function setOptions(options) {
      ...
      if (options) {
        ...
        if (!(0, _fastDeepEqual.default)(selectedPanel, options.selectedPanel)) {
  ...
  var state = (0, _merge.default)(initial, persisted);
  return {
    api: api,
    state: state
  };
