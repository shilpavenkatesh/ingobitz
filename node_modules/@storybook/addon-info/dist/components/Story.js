  ...
  _createClass(Story, [{
    ...
    value: function _getPropTables() {
      ...
      var extract = function extract(innerChildren) {
        ...
        if (typeof innerChildren === 'string' || typeof innerChildren.type === 'string' || (0, _reactIs.isForwardRef)(innerChildren) || Array.isArray(propTablesExclude) && // also ignore excluded types
      ...
      propTables = array.map(function (type, i) {
        return (// eslint-disable-next-line react/no-array-index-key
          ...
          }, "\"", getName(type), "\" Component"), _react.default.createElement(_this4.props.PropTable, {
            type: type,
            maxPropObjectKeys: maxPropObjectKeys,
            maxPropArrayLength: maxPropArrayLength,
            maxPropStringLength: maxPropStringLength,
